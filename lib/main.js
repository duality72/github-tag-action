...
function get_highest_version_for_DT(deployable_target) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let versions = tags.map(x => semver_1.coerce(x.slice(deployable_target.length + VERSION_PREFIX.length)));
        core.debug(`All versions found: ${versions}`);
        let validVersions = versions.filter(x => semver_1.valid(x));
        ...
        for (let version of validVersions) {
            ...
            if (semver_1.gt(version, highestVersion)) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let newVersion = semver_1.inc(lastVersion, "patch");
